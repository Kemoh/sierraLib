export const appslist = [
    {
        ...
        appImage: "/sierraLib/images/exampal-logo.webp",
        streamLink: "/sierraLib/apps/exams.html",
        cardColor: "lightgray"
    },
    {
        appName: "LibLocate",
        appDescription: "Find all Sierra Library outlets across the country. View locations, details, and directions — all in one app.",
        appImage: "/sierraLib/images/liblocate-logo.webp",
        streamLink: "/sierraLib/apps/locate.html",
        cardColor: "lightblue"
    }
]